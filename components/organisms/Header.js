...
const Header = () => {
  return (
    <header className="fixed w-full flex items-center justify-between h-14 text-white z-20 bg-[#111827]">
      <div className="flex items-center justify-start md:justify-center pl-4 w-20 lg:w-64 h-full">
        <h2 className="">
          <Badge dot>
            <Link href="/">
              <a className="font-bold text-base md:text-2xl lg:text-2xl text-white hover:text-white logo">
                Crypto Ranking
              </a>
            </Link>
          </Badge>
